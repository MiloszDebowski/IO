...
class FilipSmoronPizzaBuilder : public PizzaBuilder {
public:
	void buildDough() override {
		pizza.setDough("Stuffed Crust Dough");
	}
	...
	void buildTopping() override {
		pizza.setTopping("Chicken, Bacon, and Mushrooms");
	}
...
private:
	...
	int main()
	{
		...
		FilipSmoronPizzaBuilder filipSmoronBuilder;
		cook.makePizza(filipSmoronBuilder);
		Pizza filipSmoronPizza = filipSmoronBuilder.getPizza();
		filipSmoronPizza.displayPizza();
		return 0;
	}
